...
function Listado() {
    ...
    $.ajax({
        data: jsonDatos,
        type: "POST",
        url: "app/views/default/modules/catalogos/marcas/m.marcas.listado.php",
        beforeSend: function() {
            $("#divListado").html(
...
function Editar(mar_id) {
    $.ajax({
        data: "mar_id=" + mar_id,
        type: "POST",
        url: "app/views/default/modules/catalogos/marcas/m.marcas.formulario.php",
        beforeSend: function() {
            $("#divFormulario").html(
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><strong>Marcas Vehiculos</strong>
                            </h5>
